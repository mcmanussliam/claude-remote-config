...
export async function materializeRemoteAssets(projectDir, selection) {
    ...
    const skills$ = selection.skills.flatMap((skill) => writeMap(skill.files, (file) => [join(projectDir, PROJECT_FILES.skillsDir, file.relativeOutputPath), file.content]));
